export const m = {
  ...
  What_is_the_meaning_of_submission_execution_time_answer: 'Codebase might test your code multiple times with different input files. If your code gives the correct answer within the time limit for each input file, the execution time displayed is the max of the time spent for each test case. Otherwise, the execution time will have no sense.',
  ...
  How_to_report_bugs_answer_part_1: 'Codebase is open source, you can open an issue in',
